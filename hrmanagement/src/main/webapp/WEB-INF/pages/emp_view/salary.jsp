    ...
    <div class="content">
        ...
        <div class="rbox">
            ...
            <c:if test="${requestScope.salary!=null}">
                <div class="rli">
                    <li class="l1">${requestScope.salary.base}</li>
                    <li class="l1">${requestScope.salary.bonus}</li>
                    <li class="l1">${requestScope.salary.extra}</li>
                    <li class="l1">${requestScope.salary.reward}</li>
                    <li class="l1">${requestScope.salary.safe}</li>
                </div>
            </c:if>
            <div class="tit">
                <ul class="clearfix">
            ...
            <c:if test="${requestScope.salary!=null}">
                <div class="rli">
                    <li class="l1">${requestScope.salary.date}</li>
                    <li class="l1">${requestScope.salary.total}</li>
                </div>
            </c:if>
        </div>
    </div>
