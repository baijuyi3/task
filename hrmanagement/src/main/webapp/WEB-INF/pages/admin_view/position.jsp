            ...
            <c:if test="${not empty requestScope.positions}">
                <c:forEach items="${requestScope.positions}" var="i" >
                    <div class="rli">
                        ...
                        <li class="l2">
                            <a href="/position_update?id=${i.id}">编辑</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                            <a  href="/position_del?id=${i.id}">删除</a>
                        </li>
                    </div>
                </c:forEach>
            </c:if>
                ...
                <div class="rli">
                    <form action="/update_position">
                        <table>
                            <tr>
                                <td>职位名称：</td>
                                <td><input type="text" name="name" value="${requestScope.position_u.name}"></td>
                                <td>部门：</td>
                                <td>
                                    <select name="dp_id">
                        ...
                        <a class="sub" href="position">返回</a>
                    </form>
                </div>
            </c:if>
            <%--****************新建职位****************--%>
